...
and again after `T-DO-DEBT-1` and `T-DO-2`.
**Four tasks of eleven are done** (the eleventh, `T-DO-DEBT-2`, is one
`T-DO-2` added), and they are the four smallest: no pipeline exists and
...
and no application source changed in it.
